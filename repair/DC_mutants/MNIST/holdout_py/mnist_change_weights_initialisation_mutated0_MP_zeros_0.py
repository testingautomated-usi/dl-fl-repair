...
def main(model_dir, model_name):
    ...
    if (not os.path.exists(model_location)):
        ...
        epochs = 12
        model = Sequential()
        model.add(Conv2D(32, kernel_size=(3, 3), activation='relu', input_shape=input_shape, kernel_initializer='zeros'))
...
if __name__ == '__main__':
    score = main('', 'mnist_change_weights_initialisation_mutated0_MP_zeros_0.h5')
