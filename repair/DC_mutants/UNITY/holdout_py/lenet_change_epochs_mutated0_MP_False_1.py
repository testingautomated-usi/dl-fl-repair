...
def main(model_dir, model_name):
    ...
    if not (os.path.exists(model_location)):
        ...
        history = model.fit([x_img_train, x_ha_train], y_gaze_train, batch_size=128, epochs=1, shuffle=True, validation_split=0.1)
...
if (__name__ == '__main__'):
    score = main("", 'lenet_change_epochs_mutated0_MP_False_1.h5')