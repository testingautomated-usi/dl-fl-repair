...
def main(model_dir, model_name):
    ...
    if not os.path.exists(model_location):
        model = Sequential()
        model.add(Dense(512, input_shape=(max_words,), activation ='relu', kernel_initializer='ones'))
...
if __name__ == '__main__':
    score = main('', 'reuters_change_weights_initialisation_mutated0_MP_ones_0.h5')
